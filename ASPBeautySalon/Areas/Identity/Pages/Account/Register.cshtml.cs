...
namespace ASPBeautySalon.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                client.DateRegOn=DateTime.Now;

                await _userStore.SetUserNameAsync(client, Input.UserName, CancellationToken.None);
